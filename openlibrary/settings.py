...
STATIC_ROOT = os.path.join(os.path.join(PROJECT_DIR, "static_root_folder"))# os.path.join(os.path.join(PROJECT_DIR, "openlibrary"), 'staticfiles')
...
SECRET_KEY = '6=47k5&$_o!+d+y2@qelk85kj%9upp(c^u0mfj7ztfe41vqa)&'
